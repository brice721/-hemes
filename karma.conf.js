...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/view3/view3Module.js',
			'app/modules/view3/view3Ctrl.js',
			'app/modules/view3/view3Route.js',
			'app/modules/view3/view3Service.js',
			'app/modules/view3/view3-test.js',
		],
